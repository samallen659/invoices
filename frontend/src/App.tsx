...
function App() {
  ...
  const [{ status: viewStatus, isMounted: isViewing }, viewToggle] =
    useTransition({
      timeout: 500,
      mountOnEnter: true,
      unmountOnExit: true,
                        ...
                        {invoices && invoices?.length > 0 ? (
                          ...
                          <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center gap-10 pt-20 lg:pl-[103px] lg:pt-0">
                            ...
                            <div className="flex flex-col gap-6">
                              <h2 className="text-2xl font-bold text-gray-800 dark:text-white"></h2>
                  ...
                  >
                    <div className="h-full w-full bg-white dark:bg-indigo-600">
                      <InvoiceForm
                        state={formState}
                        invoice={
                          invoices != undefined && formState === "edit"
                            ? invoices[invoiceIdx]
                            : null
                        }
                        toggle={formToggle}
